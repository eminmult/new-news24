<div>
    ...
    >
        ...
        <div class="fi-sidebar-header-ctn">
            ...
            >
                <!--[if BLOCK]><![endif]--><?php if((! $hasTopbar) && $isSidebarCollapsibleOnDesktop): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2332919441-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if($shouldRenderFooter): ?>
            <div class="fi-sidebar-footer">
                <!--[if BLOCK]><![endif]--><?php if($hasDatabaseNotificationsInSidebar): ?>
                    <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2332919441-1', $__slots ?? [], get_defined_vars());
...
?>
                ...
                <!--[if BLOCK]><![endif]--><?php if($hasUserMenuInSidebar): ?>
...
<?php /**PATH /var/www/html/vendor/filament/filament/resources/views/livewire/sidebar.blade.php ENDPATH**/ ?>