...
<?php endif; ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if((! is_slot_empty($slot)) || (! is_slot_empty($footer))): ?>
        <div
            <?php if($collapsible): ?>
...
<?php /**PATH /var/www/html/vendor/filament/support/resources/views/components/section/index.blade.php ENDPATH**/ ?>