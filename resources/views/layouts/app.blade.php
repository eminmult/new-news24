...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/design.css?v=16.3.6') }}">
    <link rel="stylesheet" href="{{ asset('css/custom.css?v=1.9.0') }}">
    <link rel="stylesheet" href="{{ asset('css/responsive.css?v=2.9.0') }}">
        ...
        <div class="container">
            <div class="header-top">
                <div class="social-links">
                    ...
                    <a href="{{ $socialLinks['facebook'] }}" class="social-link" aria-label="Facebook" target="_blank" rel="noopener">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <a href="{{ $socialLinks['youtube'] }}" class="social-link" aria-label="YouTube" target="_blank" rel="noopener">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <a href="{{ $socialLinks['telegram'] }}" class="social-link" aria-label="Telegram" target="_blank" rel="noopener">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <a href="tel:{{ $socialLinks['phone'] }}" class="social-link phone-link" aria-label="Telefon">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                ...
                <nav class="nav" id="mobileNav">
                    ...
                    <div class="nav-content-wrapper">
                        ...
                        @foreach($categories ?? [] as $category)
                            <a href="{{ route('category', $category->slug) }}" class="nav-link {{ request()->is($category->slug) ? 'active' : '' }}">{{ $category->name }}</a>
                        @endforeach
                    </div>
